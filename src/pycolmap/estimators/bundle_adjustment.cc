...
void BindBundleAdjuster(py::module& m) {
  ...
  auto PyBundleAdjustmentOptions =
      py::class_<BAOpts>(m, "BundleAdjustmentOptions")
          ...
          .def_readwrite("refine_rotation_only",
                         &BAOpts::refine_rotation_only,
                         "Whether to only refine rotation while keeping "
                         "translation constant")
          .def_readwrite("fix_coord_system",
                         &BAOpts::fix_coord_system,
